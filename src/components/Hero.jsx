        ...
        <div className="container items-center lg:grid lg:grid-cols-2 lg:gap-10">
            <div>
                <div className="flex items-center gap-3">
                    <figure className="img-box w-9 h-9 rounded-lg">
                        <img
                        src="/ramdhan-np/images/avatar.jpeg"
                        width={40}
                        height={40}
                ...
                <h2 className="headline-1 max-w-[25ch] sm:max-w-[30ch] lg:max-w-[25ch] mt-4 mb-8 lg:mb-10">
                    Developing Modern Websites and Applications for the Future
                </h2>

                <div className="flex items-center gap-3">
                    <ButtonPrimary target="_blank" href='https://drive.google.com/file/d/1niadpnmkwbtNht_pT3Y561cAaLeMkhbm/view?usp=sharing' label="Download CV" icon="download"/>
            ...
            <div className="hidden lg:block">
                <figure className="w-full max-w-[400px] ml-auto bg-gradient-to-t from-sky-400 via-25% via-sky-400/40 to-60% rounded-[60px] overflow-hidden">
                    <img src="/ramdhan-np/images/Hero-banner.png" width={656} height={800} alt="Ramdhan Nugraha Pratama" className="w-full" />
                </figure>
            </div>
        </div>

    ...
    <section id="contact" className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <div className="flex gap-2 items-center mt-auto reveal-up">
                    {socialLinks.map(({href, icon}, key) => (
                        <a href={href} target="_blank" className="w-12 h-12 grid place-items-center ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-slate-50 hover:text-zinc-950 active:bg-zinc-50/80" key={key}>
                            {icon}
                        </a>
                    ))}
                </div>
            ...
            <form action="https://getform.io/f/agddddmb" method="POST" className="xl:pl-10 2xl:pl-20">
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4 reveal-up">
                        <label htmlFor="name" className="label">
                            Name
                        </label>
                        <input type="text" name="name" id="name" autoComplete="name" required placeholder="Ramdhan N P" className="text-field" />
                    </div>
                    ...
                    <div className="mb-4 reveal-up">
                        ...
                        <input type="email" name="email" id="email" autoComplete="email" required placeholder="ramdhannp@example.com" className="text-field" />
                    </div>
                ...
                <button type="submit" className="btn btn-primary w-full [&]:max-w-full justify-center reveal-up">Button</button>
            </form>
        </div>
    </section>
  )
